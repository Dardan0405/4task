...
const [click,setclick] = useState(false);
    return(
        <div className="Parking">
            ...
            <button className="AboutUs" onClick={() => setclick(!click)}>How does the Parkname seperate itself from other domain praking companies?<div className="Arrow">{click ? <MdKeyboardArrowUp/>:<MdKeyboardArrowRight/>}</div></button>
