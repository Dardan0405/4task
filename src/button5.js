...
function Parking5(){
    ...
    return(
        <div className="Parking">
            ...
            <button className="AboutUs" onClick={() => setclick(!click)}>When was the first Parkname founded<div className="Arrow" > {click ? <MdKeyboardArrowUp/>:<MdKeyboardArrowRight/>} </div></button>
